  ...
  <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      ...
      <form action="{{route('SalvaNoticia')}}" method="post" class="space-y-8">
        @csrf
          ...
          <a href= "{{route('gerenciaNoticias')}}" class="border border-red-700 py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-blue-700 sm:w-fit hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Voltar</a>
